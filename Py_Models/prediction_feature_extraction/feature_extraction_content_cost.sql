...
from {database}.{schema}.{funnel_metrics_table} as f
...
--       on f.match_id = concat(mapped_id, case when rad.content_category = 'series'
--            then concat('-',to_char(ifnull(h.season_number, 1))) else '' end)
